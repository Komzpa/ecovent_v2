...
Version 1.2.14
* In silent manual-speed mode, keep Home Assistant preset changes effective
  even when a device does not report configurable preset speed setpoints, by
  falling back to deterministic low/medium/high manual-speed percentages
  instead of reusing the current manual speed.
